...
<head>
	...
	<script src='validatesearch.js' type='text/javascript'> </script>
</head>
<?php
		...
		<div class="row">
			...
			<div class="col-md-9 container ">
				<ul class="nav nav-tabs nav-justified" style="margin-left:-105px;margin-top:-21px">
						...
						<li class="active"><a href="Manager_Employee_Search.php">Search </a></li>
				</ul>
				...
				<div class="tab-content">
							...
							<form action="searchemployee.php" method="post" onsubmit="return validate()">
								<input type="radio" name="emp_search" id="name" value="1" checked> Name of the employee</input> </br>
								<input type="radio" name="emp_search" id="ID" value="2"> ID of the Employee</input> <br/> <br/>
