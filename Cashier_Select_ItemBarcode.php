    ...
    <div class="row">
      ...
      <div class="col-md-9"> 
             ...
             if($result->num_rows > 0)
                {
                   ...
                   while($row = $result->fetch_assoc() ){
                      ...
                      $s_id = "";
                      $barcode = "";
                      $sql2 = "SELECT s_id from `stock` where i_id= '$i_id'";
                      //echo $sql2;
                      $result2 = $conn->query($sql2);
                      if($result2->num_rows > 0){
                        while($row2 = $result2->fetch_assoc() ){
                          $s_id = $row2["s_id"];
                          $sql3 = "SELECT barcode from `barcode` where s_id = '$s_id'";
                          //echo $sql3;
                     ...
                     // $cimg = $row['image'];*/
                      ...
                      echo "<div id=\"".$cname."\"><tr><td> ".$slno."</td><td> ".$barcode."</td><td>".$cname."<td>".$price. "<br><input type=\"checkbox\" name=\"item[$counter]\" value=\"$i_id\">
        ...
        <div  style="position:fixed; width:350px; left:0px;bottom:0px;z-index:1000;background-color:#e0e0e0">
          ...
          <h5 style="margin:2 50 2 2; color:black;padding-left:5px;padding-right:5px;" >Enter barcode : <input id="searchbar" style="color:black" 
